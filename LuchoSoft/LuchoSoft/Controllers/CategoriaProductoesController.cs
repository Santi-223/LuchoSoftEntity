...
namespace LuchoSoft.Controllers
{
    public class CategoriaProductoesController : Controller
    {
        ...
        public CategoriaProductoesController(LuchoSoftV1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.CategoriaProductos != null ? 
                          ...
                          Problem("Entity set 'LuchoSoftV1Context.CategoriaProductos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LuchoSoftV1Context.CategoriaProductos'  is null.");
            }
            var categoriaProducto = await _context.CategoriaProductos.FindAsync(id);
            if (categoriaProducto != null)
            {
