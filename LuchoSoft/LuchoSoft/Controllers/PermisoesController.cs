...
namespace LuchoSoft.Controllers
{
    public class PermisoesController : Controller
    {
        ...
        public PermisoesController(LuchoSoftV1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Permisos != null ? 
                          ...
                          Problem("Entity set 'LuchoSoftV1Context.Permisos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LuchoSoftV1Context.Permisos'  is null.");
            }
            var permiso = await _context.Permisos.FindAsync(id);
            if (permiso != null)
            {
