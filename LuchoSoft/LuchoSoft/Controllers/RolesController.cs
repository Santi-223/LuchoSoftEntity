...
namespace LuchoSoft.Controllers
{
    public class RolesController : Controller
    {
        ...
        public RolesController(LuchoSoftV1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Roles != null ? 
                          ...
                          Problem("Entity set 'LuchoSoftV1Context.Roles'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdRol,NombreRol,DescripcionRol,EstadoRol")] Role role)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LuchoSoftV1Context.Roles'  is null.");
            }
            var role = await _context.Roles.FindAsync(id);
            if (role != null)
            {
